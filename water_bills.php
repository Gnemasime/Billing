...
// Base query to select water bills for the current user with pagination
$sql = "SELECT * FROM bills WHERE resident_id = ? AND service_type = 'water'";
...
// Get the total number of bills for pagination
$sql_total = "SELECT COUNT(*) AS total FROM bills WHERE resident_id = ? AND service_type = 'water'";
if ($status_filter !== 'all') {
