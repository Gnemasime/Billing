...
$params = [
    ...
    'keywords' => 'water', // Search keywords
...
<body>
     ...
     <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
           ...
           <a class="nav-link dropdown-toggle" href="loadshedding.php" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <div class="container profile-container"><br>
        <h2 class="text-center mb-4">Latest News on Water</h2>
        <br><hr><br>
